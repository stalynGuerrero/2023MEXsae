...
library(ggplot2)
library(dplyr)
encuesta_agregada <- readRDS("Recursos/Día2/Sesion4/Data/encuestaMEX20N1.rds") %>% 
  group_by(
     dam ,
    dam2 
    ) %>% 
...
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Bernoulli/plot_comp.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Ingreso.PNG")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Ingreso1.PNG")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Ingreso2.PNG")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Ingreso3.PNG")
```
...
```{r, echo=FALSE}
tablas <- readRDS("Recursos/Día2/Sesion4/0Recursos/tablas.rds")
```
...
ShapeSAE <- read_sf("Recursos/Día2/Sesion4/Shape/MEX_dam2.shp") 
...
tmap_save(Mapa_lp, 
          filename = "Recursos/Día2/Sesion4/0Recursos/Map_MEX.PNG",
           width = 2500,
  height = 2000,
  asp = 0)
...
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Map_MEX.PNG")
```
...
```{r echo=FALSE, out.width = "400%",fig.align='center'}
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Mosaico.png")
```