...
knitr::include_graphics("Recursos/Día2/Sesion1/0Recursos/FH1.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día2/Sesion1/0Recursos/FH2.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día2/Sesion1/0Recursos/rhat.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día2/Sesion1/0Recursos/FH3.png")
```
...
# saveRDS(data_dir, "Recursos/Día2/Sesion1/0Recursos/data_dir.rds")
# saveRDS(data_syn, "Recursos/Día2/Sesion1/0Recursos/data_syn.rds")

data_dir <- readRDS("Recursos/Día2/Sesion1/0Recursos/data_dir.rds")
data_syn <- readRDS("Recursos/Día2/Sesion1/0Recursos/data_syn.rds")
tba(data_syn %>% slice(1:10) %>%
      select(dam2:hat_var,theta_pred:Cv_theta_pred))
...
knitr::include_graphics("Recursos/Día2/Sesion1/0Recursos/validar_bench.png")
```
...
knitr::include_graphics("Recursos/Día2/Sesion1/0Recursos/Mapa_MEX_pobreza_normal.PNG")
```
