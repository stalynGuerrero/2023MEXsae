...
```{r, echo=FALSE}
indicador_dam1 <- readRDS("Recursos/Día3/Sesion4/Data/base_modelo.Rds")
...
knitr::include_graphics("Recursos/Día3/Sesion4/0Recursos/theta_ajustado.png")
```  
...
```{r echo=FALSE, out.width = "800px", out.height="200px",fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion4/0Recursos/ppc.png")
```  
...
```{r, echo=FALSE}
estimaciones <- readRDS("Recursos/Día3/Sesion4/Data/estimaciones.rds")
tba(head(estimaciones,10))
```
...
```{r echo=FALSE, out.width = "800px", out.height="200px",fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion4/0Recursos/Plot_Bench_gk.jpeg")
```  
...
```{r, echo=FALSE}
# saveRDS(tabla_validar, "Recursos/Día3/Sesion4/0Recursos/tabla_validar.rds")
tabla_validar <- readRDS("Recursos/Día3/Sesion4/0Recursos/tabla_validar.rds")
tba(tabla_validar)
...
```{r, echo=FALSE}
estimaciones <- readRDS("Recursos/Día3/Sesion4/Data/estimaciones_Bench.rds")
```
...
knitr::include_graphics("Recursos/Día3/Sesion4/0Recursos/Ocupados.png")
```
...
```{r echo=FALSE, out.width = "800%" , fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion4/0Recursos/Desocupados.png")
```
...
```{r echo=FALSE, out.width = "800%", fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion4/0Recursos/Inactivo.png")
```
