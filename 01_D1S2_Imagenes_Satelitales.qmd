...
```{r, echo=FALSE}
include_graphics("Recursos/Día1/Sesion2/0Recursos/MEX_1.png")
```
...
readRDS("Recursos/Día1/Sesion2/Data/predictors_satelital_dam.rds") %>%
  ...
  tba( cap = "Promedio de luces nocturnas estandarizada")
```
...
predictors_satelital <-
  readRDS("Recursos/Día1/Sesion2/Data/predictors_satelital_estan_dam.rds") 


tba(head(predictors_satelital, 10), 
    cap = "Predictores satelitales estandarizados")
```

Los resultados se muestran en los siguientes mapas

```{r, echo=FALSE, eval=FALSE}
temp <- inner_join(shape["dam"], predictors_satelital, by = "dam") 
# Cargar la biblioteca tmap si aún no está cargada
library(tmap)
paso <- names(predictors_satelital[-1])
# Crear un objeto de mapa
mapa <- tm_shape(temp)
for(ii in paso){
brks_lp <- round(quantile(predictors_satelital[[ii]]))
# Crear el mapa con luces nocturnas
Mapa_lp <- mapa + 
 tm_polygons(
    ii,
    breaks = brks_lp,
...
# Guardar el mapa como una imagen PNG
tmap_save(Mapa_lp, 
          filename = paste0("Recursos/Día1/Sesion2/0Recursos/", ii, ".png"),
           width = 1200,
  height = 800,
  asp = 0)
}
...
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/Luces_MEX_satelite.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/suelo_cultivo.png")
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/suelo_cultivo_MEX.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/suelo_urbano.png")
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/suelo_urbanos_MEX.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/modificacion_humana.png")
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/modifica_humana_MEX.png")
```

### Tiempo promedio al hospital 

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/accesibilidad_hospitales.png")
 knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/tiempo_hospital_MEX.png")
```

### Tiempo promedio al hospital en vehiculo no motorizado

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/accesibilidad_hosp_caminado.png")
knitr::include_graphics("Recursos/Día1/Sesion2/0Recursos/tiempo_hospital_no_motor_MEX.png")
```
...
```{r, echo=FALSE}
readRDS("Recursos/Día1/Sesion2/Data/predictors_satelital_dam.rds") %>% 
  dplyr::select(dam,piso_tierra) %>% arrange(dam) %>% 
  tba()
```
...
```{r, eval=FALSE, echo=FALSE, out.width = "400%"}
temp2 <- predictors_censo_dam %>% select(-dam) %>% names()
paso <- inner_join(shape, predictors_censo_dam)
paso <- tm_shape(paso)
for (ii in temp2) {
  p <- paso + tm_polygons(
    col = ii,
  ...
  s_ii <- paste0("Recursos/Día1/Sesion2/0Recursos/", ii, " .png")
  tmap_save(
    tm =  p,
    filename = s_ii,
    width = 1500,
