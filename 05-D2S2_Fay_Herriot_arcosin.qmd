...
knitr::include_graphics("Recursos/Día2/Sesion2/0Recursos/FH_Asin.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día2/Sesion2/0Recursos/FH_Asin2.png")
```
...
# saveRDS(data_dir, "Recursos/Día2/Sesion2/0Recursos/data_dir.rds")
# saveRDS(data_syn, "Recursos/Día2/Sesion2/0Recursos/data_syn.rds")
```
...
knitr::include_graphics("Recursos/Día2/Sesion2/0Recursos/Mapa_arcoseno.PNG")
```
...
```{r echo=FALSE,  out.width="400%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion2/0Recursos/Mapa_arcoseno_cv.PNG")
```
