...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("0Recursos/rhat.png")
```
...
ggsave(plot = p1,
       filename = "0Recursos/validar_bench.png",width = 16,height = 12)
p1 
```

```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("0Recursos/validar_bench.png")
```
## Mapa de pobreza
...
tmap_save(Mapa_lp, 
          filename = "0Recursos/Mapa_MEX_pobreza_normal.PNG",
           width = 2500,
  height = 2000,
  asp = 0)
Mapa_lp
...
knitr::include_graphics("0Recursos/Mapa_MEX_pobreza_normal.PNG")
```
