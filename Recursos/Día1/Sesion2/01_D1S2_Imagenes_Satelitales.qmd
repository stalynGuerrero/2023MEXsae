...
```{r, eval=FALSE}
shape <- read_sf("Shape/MEX_dam.shp") 
#shape <- read_sf("Shape/MEX_dam2.shp")
plot(shape["geometry"])
```


```{r, echo=FALSE}
include_graphics("0Recursos/MEX_1.png")
```
...
predictors_satelital <-
  readRDS("Data/predictors_satelital_estan_dam.rds") 
...
tmap_save(Mapa_lp, 
          filename = paste0("0Recursos/", ii, ".png"),
           width = 1200,
  height = 800,
  asp = 0)
}
...
knitr::include_graphics("0Recursos/Luces_MEX_satelite.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/suelo_cultivo.png")
knitr::include_graphics("0Recursos/suelo_cultivo_MEX.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/suelo_urbano.png")
knitr::include_graphics("0Recursos/suelo_urbanos_MEX.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/modificacion_humana.png")
knitr::include_graphics("0Recursos/modifica_humana_MEX.png")
```

### Tiempo promedio al hospital 

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/accesibilidad_hospitales.png")
 knitr::include_graphics("0Recursos/tiempo_hospital_MEX.png")
```

### Tiempo promedio al hospital en vehiculo no motorizado

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/accesibilidad_hosp_caminado.png")
knitr::include_graphics("0Recursos/tiempo_hospital_no_motor_MEX.png")
```
...
```{r, eval=FALSE}
library(redatam)
mexico <- redatam.open("Data/cpv2020mex-cde.dicX")
...
```{r}
predictors_censo_dam <- readRDS("Data/predictors_satelital_dam.rds") %>% 
...
```{r, out.width = "400%"}
temp2 <- predictors_censo_dam %>% select(-dam) %>% names()
temp2 <- paste0("0Recursos/", temp2, " .png")
