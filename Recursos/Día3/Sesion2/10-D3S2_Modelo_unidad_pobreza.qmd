...
saveRDS(fit, file = "Data/fit_pobreza2.rds")
...
```{r}
fit <- readRDS("Data/fit_pobreza2.rds")
```
...
ggsave(plot = p1,
       filename = "0Recursos/pobreza1.PNG",
       scale = 2)
```

```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("0Recursos/pobreza1.PNG")
```
...
ggsave(plot = p1,
       filename = "0Recursos/pobreza2.PNG",
       scale = 2)
```

```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("0Recursos/pobreza2.PNG")
```
